 ...
 * /{userId}/transaction:
 *   get:
 *     description: This endpoint allows the active user to get a existing transaction.
 *     responses:
 *       200:
 *         description: Successful authentication, returns user data.
 *         headers:
 ...
 * /{userId}/transaction:
 *   delete:
 *     description: This endpoint allows the active user to delete a existing transaction.
 *     responses:
 *       204:
 *         description: Successful authentication, returns user data.
 *         headers:
 ...
 * /{userId}/transaction:
 *   patch:
 *     description: This endpoint allows the active user to patch a new transaction.
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 * /{userId}/transaction:
 *   patch:
 *     description: This endpoint allows the active user to put a new transaction.
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
